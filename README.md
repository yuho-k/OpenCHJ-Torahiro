...
### [openchj: 形態論データ（CSV）](https://github.com/yuho-k/OpenCHJ-Torahiro/tree/main/openchj)
- フィールド
  - sample_id: サンプルID
  - start: 開始位置
  - end: 終了位置
...
### [texts: テキストデータ](https://github.com/yuho-k/OpenCHJ-Torahiro/tree/main/texts)
- text_rev: key列を結合したテキストデータ（踊り字を開く、誤字を修正するなどの校訂を施した行区切りの本文）
- text_orig: 原文文字列を結合したテキストデータ
